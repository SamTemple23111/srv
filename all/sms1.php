    ...
    <div class="page-wrapper with-navbar with-sidebar">
        ...
        <div class="navbar">
            ...
            <a href="#" class="navbar-brand">
                <img src="images/icon.svg" alt="icon" width="30" height="30"> EMBLEM SMS MAILER
            </a>
        ...
        <div class="sidebar">
            <div class="sidebar-menu">
                ...
                <a href="sms2.html" class="sidebar-link sidebar-link-with-icon">
                    <span class="sidebar-icon">
                        <i class="fa-solid fa-pen"></i>
                    </span>
                    SMS 2
                </a>
                <a href="sms3.html" class="sidebar-link sidebar-link-with-icon active">
                    <span class="sidebar-icon bg-primary text-white">
                        <i class="fa-solid fa-pen"></i>
                    </span>
                    SMS 3
                </a>
                <a href="sms4.html" class="sidebar-link sidebar-link-with-icon">
                    <span class="sidebar-icon">
                        <i class="fa-solid fa-pen"></i>
                    </span>
                    SMS 4
                </a>
                <a href="sms5.html" class="sidebar-link sidebar-link-with-icon">
                    <span class="sidebar-icon">
                        <i class="fa-solid fa-pen"></i>
                    </span>
                    SMS 5
                </a>
                <a href="sms6.html" class="sidebar-link sidebar-link-with-icon">
                    <span class="sidebar-icon">
                        <i class="fa-solid fa-pen"></i>
                    </span>
                    SMS 6
                </a>
                <a href="sms7.html" class="sidebar-link sidebar-link-with-icon">
                    <span class="sidebar-icon">
                        <i class="fa-solid fa-pen"></i>
                    </span>
                    SMS 7
                </a>
                <a href="sms8.html" class="sidebar-link sidebar-link-with-icon">
                    <span class="sidebar-icon">
                        <i class="fa-solid fa-pen"></i>
                    </span>
                    SMS 8
                </a>
                <a href="sms9.html" class="sidebar-link sidebar-link-with-icon">
                    <span class="sidebar-icon">
                        <i class="fa-solid fa-pen"></i>
                    </span>
                    SMS 9
                </a>
                <a href="sms10.html" class="sidebar-link sidebar-link-with-icon">
                    <span class="sidebar-icon">
                        <i class="fa-solid fa-pen"></i>
                    </span>
                    SMS 10
            ...
            <div class="container-fluid">
                <div class="row row-eq-spacing align-items-center">
                    <div class="col-12 col-sm-auto">
                        <h4 class="my-0">
                            <i class="fa-solid fa-pen mr-5"></i> SMS USA
                        </h4>
                    </div>
                </div>
