...
<body class="dark-mode with-custom-css-scrollbars with-custom-webkit-scrollbars">
    ...
    <div class="page-wrapper with-navbar with-sidebar">
        ...
        <div class="sidebar">
            <div class="sidebar-menu">
                ...
                <a href="sms7.php" class="sidebar-link sidebar-link-with-icon active">
                ...
                <a href="sms10.php" class="sidebar-link sidebar-link-with-icon">
                    <span class="sidebar-icon">
                        <i class="fa-solid fa-pen"></i>
                    </span>
                    SRV 10
    ...
    <script src="js/srv7.js" type="text/javascript" ></script>
</body>
</html>
